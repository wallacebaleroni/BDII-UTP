...
CREATE TABLE Corrida(
	...
	categoria INT NOT NULL,
	time_ini TIMESTAMP NOT NULL,
	time_fim TIMESTAMP NOT NULL,
	end_ini VARCHAR NOT NULL,
	end_fim VARCHAR NOT NULL,
	
	CONSTRAINT PK_Corrida PRIMARY KEY (passageiro, time_ini),
...
INSERT INTO Categoria VALUES(1, 'Uber X');
INSERT INTO Categoria VALUES(2, 'Uber Black');

INSERT INTO Carro VALUES(1234, 'CAM2010', 'Chevrolet', 'Camaro', 2010, 1);
INSERT INTO Carro VALUES(5678, 'PSC2018', 'Porsche', '718', 2018, 2);

INSERT INTO Motorista VALUES('102.938.475-60', 'Jorge', 'jorge@bol.com', 12443857, 1234);
INSERT INTO Motorista VALUES('121.334.543-24', 'Marcos', 'marcos@uol.com', 84782478, 5678);
INSERT INTO Motorista VALUES('645.788.546-45', 'Roger', 'roger@aol.com', 17654378, 5678);

INSERT INTO Corrida VALUES('123.456.789-10', '102.938.475-60', 1, now(), now(), 'Aqui', 'Ali');
INSERT INTO Corrida VALUES('987.654.321-00', '121.334.543-24', 2, now(), now(), 'Ali', 'Aqui');
